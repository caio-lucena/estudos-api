...
public class ProductResponse {
    ...
    public ProductResponse (String nameInit, Integer amountInit, Double priceInit){
        name = nameInit;
    ...
    public ProductResponse (String nameInit, Integer amountInit, Double priceInit, String descriptionInit){
        name = nameInit;
